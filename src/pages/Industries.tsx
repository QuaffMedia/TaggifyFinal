          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-gray-50 rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-700 mb-4">
                A leading voice-based BPO serving global financial clients was struggling with quality issues and compliance concerns. Our comprehensive audit identified critical gaps in call monitoring, script compliance, and customer data handling.
              </p>
              <p className="text-gray-700 mb-4">
