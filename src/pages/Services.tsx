...
const Services: React.FC<ServicesProps> = ({ serviceSlug }) => {
  ...
  <div className="container mx-auto px-4">
        ...
        {service.process.map((step, index) => (
          <div key={index} className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="flex-shrink-0 bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold shadow-md z-10">
                {index + 1}
              </div>
    ...
    <div className="text-center mt-6">
      <Link 
        to="/contact" 
        className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-7 rounded-md text-base transition-colors duration-300"
      >
